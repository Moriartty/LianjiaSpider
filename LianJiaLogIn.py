...
home_url = 'http://hui.lianjia.com/'
auth_url = 'https://passport.lianjia.com/cas/login?service=http%3A%2F%2Fhui.lianjia.com%2F'
chengjiao_url = 'http://hui.lianjia.com/chengjiao/'
...
# 获取lianjia_uuid
req = urllib2.Request('http://hui.lianjia.com/')
opener.open(req)
# 初始化表单
...
# data
data = {
    'username': '13889446741', #替换为自己账户的用户名
    'password': '313569773b', #替换为自己账户的密码
    'execution': execution,
    '_eventId': 'submit',
    'lt': lt,
    'verifyCode': '',
...
headers = {
    ...
    'Pragma': 'no-cache',
    'Referer': 'https://passport.lianjia.com/cas/login?service=http%3A%2F%2Fhui.lianjia.com%2F',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.111 Safari/537.36',
    'Upgrade-Insecure-Requests': '1',
